...
#define SUPPLY_2V85		2850000UL//changhua added
...
#define SUPPLY_ANA_MIN		SUPPLY_2V85//changhua added for fpc1150 datasheet 1.8~3.3V
#define SUPPLY_ANA_MAX		SUPPLY_2V85
