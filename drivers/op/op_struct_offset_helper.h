...
extern int get_task_struct_offset(int member);
...
#define RQ_CLOCK_R(rq) (*(u64 *)((char *)rq + get_rq_struct_offset(RQ_OFFSET_CLOCK)))
extern int get_rq_struct_offset(int member);
